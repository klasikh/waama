    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">WAAMA</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'ActualitiesList' ? activeClass : inactiveClass]"
          to="/actualities-list"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Actualités</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'CadresList' ? activeClass : inactiveClass]"
          to="/cadres-list"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Cadres</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'EventsList' ? activeClass : inactiveClass]"
          to="/events-list"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Evénements</span>
        </router-link>
        ...
        >
          ...
          <span class="mx-4">Newsletters</span>
        </router-link>
        <!-- 
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
